...
namespace KutuphaneOtomasyon.Model
{
	public class Kisi
	{
        ...
        public Kisi(int id,string isim,string soyisim,DateTime olusturmaTariih,string kullaniciadi,string sifre,string yetki)
        {
            this.id = id;
			this.isim = isim;
			this.soyisim = soyisim;
			this.olusturmaTarih = olusturmaTariih;
